    ...
    <div className="min-h-screen flex justify-center items-center bg-gray-100 dark:bg-[#0f172a] p-6">
      ...
      <div className="bg-white dark:bg-[#1e293b] w-full max-w-xl p-10 rounded-2xl shadow-2xl text-gray-800 dark:text-gray-100">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <input
            type="file"
            className="file-input file-input-bordered w-full bg-white dark:bg-[#0f172a] text-gray-800 dark:text-gray-100 border-gray-300 dark:border-gray-700"
            {...register("photo")}
          />
          ...
          {/* ROLE */}
          <select
            className="select select-bordered w-full bg-white dark:bg-[#0f172a] text-gray-800 dark:text-gray-100 border-gray-300 dark:border-gray-700"
          ...
          <input
            ...
            {...register("bank_account_no", { required: "Bank account required" })}
          />
