...
const Contact = () => {
    ...
    try {
      ...
      if (res.data?.insertedId || res.data?.acknowledged) {
        toast.success("Message sent successfully!", {
          duration: 3000,
          style: { background: "#4f46e5", color: "white", fontWeight: "500" },
        });
        reset();
      }
    } catch (error) {
  ...
  return (
    <div className="min-h-screen pt-28 mt-10 bg-gradient-to-br from-purple-50 via-blue-50 to-cyan-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 px-4 sm:px-6 lg:px-20 pb-12">
      ...
      >
        <h1 className="text-3xl sm:text-4xl font-bold mb-3 text-gray-800 dark:text-gray-100">
          Get in Touch
        </h1>
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-6 sm:p-8 space-y-6 border border-gray-200 dark:border-gray-700"
        >
          ...
          {/* Map */}
          <div className="w-full h-64 rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 mt-4">
            <MapContainer center={position} zoom={14} scrollWheelZoom={false} className="h-full w-full">
              ...
              <Marker position={position}>
                <Popup>NC Group Office <br /> Dhaka, Bangladesh</Popup>
              </Marker>
            </MapContainer>
          </div>
        </motion.div>
        ...
        <motion.form
          ...
          transition={{ duration: 0.6 }}
          viewport={{ once: true }}
          className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-6 sm:p-8 space-y-5 border border-gray-200 dark:border-gray-700"
        >
